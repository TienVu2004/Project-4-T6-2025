        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="customer" role="form" method="GET" action="/lien-he" class="form-horizontal" id="form-contact">
                        <div class="row">
                            <div class="col">
                                <form:input path="fullName" class="form-control" name="fullName" placeholder="Họ và tên"/>
                        ...
                        <form:input path="phone" class="form-control mt-3" name="phone" placeholder="Số điện thoại"/>
                        <span class="error-message" style="color:red" id="phone"></span>

                        <form:input path="demand" class="form-control mt-3" name="demand" placeholder="Nội dung"/>

                        <button type="button" class="btn btn-primary px-4 mt-3" id="btnContact">Gửi liên hệ</button>
                    </form:form>
                </div>
            </div>
        </div>
...
<script>
    ...
    function validateDateCustomer(json){
        ...
        if(json['phone'] === ''){
            ok = 0;
            $('#phone').after('<span style="color:red" class="error-message">SĐT không được để trống</span>');
        }
    }
