...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
                ...
                .authorizeRequests()
                        ...
                        .antMatchers("api/assign/customer").hasRole("MANAGER")
                        .antMatchers(HttpMethod.DELETE,"api/customers/{ids}").hasRole("MANAGER")
                        .antMatchers("/api/customers/{id}/staffs").hasRole("MANAGER")
                        .antMatchers(HttpMethod.DELETE,"api/transactions/{id}/{code}/{customerId}").hasRole("MANAGER")
                        ...
                        .antMatchers("/login", "/resource/**", "/trang-chu", "/api/**","/api/user/register", "/lien-he").permitAll()
                .and()
